            ...
            <main className="relative bg-[url('/image/asset/cover-depan.webp')] p-5 bg-cover text-center items-center justify-center flex flex-col h-full">
                  ...
                  <div className="bg-primary-light h-full rounded-[200px] md:rounded-[280px] z-10 w-full shadow-lg flex overflow-hidden flex-col items-center justify-center gap-2 pb-28">
                        <motion.div
                              ...
                              className="relative w-full h-full max-h-90"
                        >
                        ...
                        <motion.h2
                              ...
                              className="text-2xl md:text-3xl font-semibold text-primary-dark mt-3"
                        >THANK YOU FOR YOUR <br /> ATTENDANCE</motion.h2>
                        <motion.p
                              initial={{ opacity: 0 }}
                              whileInView={{ opacity: 1 }}
                              viewport={{ once: true }}
                              transition={{ duration: 0.6, ease: "easeOut", delay: 0.35 }}
                              className="text-sm text-neutral-800 max-w-90"
                        >
                        ...
                        <motion.p
                              ...
                              className="font-dancing-script text-xl text-primary-dark mt-3"
                        >
                              Novan & Silvy
                        </motion.p>
                  </div>
