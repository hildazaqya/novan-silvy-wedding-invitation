...
export function WeddingEvent() {
      return (
            <main className="relative overflow-hidden bg-white flex flex-col gap-3 lg:gap-6 min-h-screen items-center justify-center px-5 py-10 lg:p-10">
                  ...
                  <hr className="border border-primary-light w-full" />

                  {/* Pemberkatan */}
                  <div className="z-10 bg-primary-light/40 backdrop-blur-md border border-primary-light-500/40 rounded-2xl p-5 w-full flex flex-col gap-3 mt-3 lg:mt-0">
                  ...
                  {/* Resepsi */}
                  <div className="z-10 bg-primary-light/40 backdrop-blur-md border border-primary-light-500/40 rounded-2xl p-5 w-full mb-10 md:mb-20 flex flex-col gap-3">
